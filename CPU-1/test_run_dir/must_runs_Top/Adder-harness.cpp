...
#endif
#if VM_COVERAGE
  VerilatedCov::write("C:\Users\kenta\VScodeProject\GithubProject\CPU_FirstActivityWithShinrabansho\CPU-1\test_run_dir\must_runs_Top/coverage.dat");
#endif
  top->final();
  // TODO: re-enable!
  // delete top;
...
struct sim_state {
  ...
  inline void poke(int32_t id, int64_t value) {
    ...
    switch(id) {
      ...
      case 1 : dut->io_a = u; break;
      case 2 : dut->io_b = u; break;
  ...
  inline int64_t peek(int32_t id) {
    ...
    switch(id) {
      ...
      case 1 : value = dut->io_a; break;
      case 2 : value = dut->io_b; break;
      case 3 : value = dut->io_out; break;
...
static sim_state* create_sim_state() {
  ...
  std::string dumpfile = "C:\Users\kenta\VScodeProject\GithubProject\CPU_FirstActivityWithShinrabansho\CPU-1\test_run_dir\must_runs_Top\Adder.fst";
